...
class RebuildInvoiceJournals extends Command
{
    ...
    public function handle()
    {
        ...
        $this->info('1. Memulihkan status invoice yang seharusnya PAID.');
        ...
        $this->info('4. Menyinkronkan Buku Pembantu piutang.');
        $this->newLine();
