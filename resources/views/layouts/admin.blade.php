    ...
    <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
        <div class="sidebar-brand d-none d-md-flex" style="background: rgba(0,0,0,0.15); padding: 1rem 0;">
            <span class="sidebar-brand-full fw-bold fs-5 d-flex align-items-center justify-content-center">
                <img src="{{ asset('favicon.png') }}" alt="Logo TPST" class="me-2" style="height: 36px; width: auto; object-fit: contain; border-radius: 4px;">
                TPST App
            </span>
            <span class="sidebar-brand-narrow fw-bold d-flex align-items-center justify-content-center">
                <img src="{{ asset('favicon.png') }}" alt="Logo TPST" style="height: 28px; width: auto; object-fit: contain; border-radius: 4px;">
            </span>
        </div>
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
            ...
            <li class="nav-group {{ request()->is('admin/laporan-operasional*') ? 'show' : '' }}">
                ...
                <ul class="nav-group-items compact">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.laporan-operasional.kartu-stok-item') ? 'active' : '' }}" href="{{ route('admin.laporan-operasional.kartu-stok-item') }}"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Kartu Stok Item</a>
                    </li>
                    @endcanany
