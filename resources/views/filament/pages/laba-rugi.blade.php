...
<x-filament-panels::page>
    <div class="space-y-4">
        ...
        @include('filament.pages.partials.laba-rugi-content', ['data' => $data, 'dari' => $dari, 'sampai' => $sampai, 'tenant' => $tenant])
...
<body>
    @include('filament.pages.partials.laba-rugi-content', ['data' => $data, 'dari' => $dari, 'sampai' => $sampai])
</body>
</html>
@endif
