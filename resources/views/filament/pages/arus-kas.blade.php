...
<x-filament-panels::page>
    <div class="space-y-4">
        ...
        @include('filament.pages.partials.arus-kas-content', ['data' => $data, 'dari' => $dari, 'sampai' => $sampai, 'isExport' => $isExport ?? false, 'tenant' => $tenant])
...
<head>
    ...
    <style>
        ...
        .grid-cols-3 > div { float: left; width: 31%; margin-right: 2%; box-sizing: border-box; }
        .grid-cols-3 > div:last-child { margin-right: 0; }
