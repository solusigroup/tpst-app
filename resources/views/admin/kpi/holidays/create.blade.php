...
@section('title', 'Tambah Hari Libur - TPST Performance Management')
...
<div class="page-header d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-4">
    <div>
        <h1 class="h3 mb-1 text-primary fw-bold">
            <i class="cil-calendar me-2"></i>Tambah Hari Libur
        </h1>
    ...
    <div class="col-md-7 col-lg-6">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white py-3">
                <h5 class="card-title mb-0 text-dark fw-bold">Form Input Hari Libur</h5>
                <small class="text-muted">Hari libur yang dicatat di sini tidak akan dihitung sebagai hari kerja pada penilaian KPI.</small>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.kpi.holidays.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ old('nama') }}" placeholder="Contoh: Hari Raya Idul Fitri 1447 H, Tahun Baru, Cuti Bersama" required>
                        @error('nama')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
