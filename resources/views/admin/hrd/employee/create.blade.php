            ...
            <div class="card-body">
                <form action="{{ route('admin.hrd.employee.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6" id="payment_frequency_container" style="display: {{ old('salary_type') == 'bulanan' ? 'none' : 'block' }};">
                            ...
                            <select name="payment_frequency" class="form-select @error('payment_frequency') is-invalid @enderror">
                                <option value="Mingguan" {{ old('payment_frequency') == 'Mingguan' ? 'selected' : '' }}>Mingguan (Tiap Sabtu)</option>
                                <option value="Dua Mingguan" {{ old('payment_frequency') == 'Dua Mingguan' ? 'selected' : '' }}>Dua Mingguan</option>
                            </select>
                    ...
                    <div class="row mb-3" id="daily_wage_container" style="display: {{ old('salary_type') == 'harian' ? 'flex' : 'none' }};">
                        <div class="col-md-6">
                            <label class="form-label">Upah Harian (Rp) <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input type="number" name="daily_wage" id="daily_wage" class="form-control @error('daily_wage') is-invalid @enderror" value="{{ old('daily_wage') }}" min="0" step="1">
                            </div>
