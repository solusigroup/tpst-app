                ...
                <form action="{{ route('admin.hrd.employee.update', $employee->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="date" name="joined_at" class="form-control @error('joined_at') is-invalid @enderror" value="{{ old('joined_at', $employee->joined_at?->format('Y-m-d')) }}">
                            @error('joined_at') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Tgl Berhenti Kerja</label>
                            <input type="date" name="ended_at" class="form-control @error('ended_at') is-invalid @enderror" value="{{ old('ended_at', $employee->ended_at?->format('Y-m-d')) }}">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select name="bpjs_status" class="form-select @error('bpjs_status') is-invalid @enderror" required>
                                <option value="Tidak Aktif" {{ old('bpjs_status', $employee->bpjs_status) == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                                <option value="Aktif" {{ old('bpjs_status', $employee->bpjs_status) == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                            </select>
