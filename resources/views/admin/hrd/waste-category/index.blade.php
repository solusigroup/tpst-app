        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead class="table-light">
                    <tr><th>Nama Kategori</th><th>Deskripsi</th><th>Satuan</th><th>Harga Beli</th><th>Harga Jual</th><th>Status</th><th class="text-end">Aksi</th></tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->unit }}</td>
                        <td>
                            @if($item->active_wage_rate)
                                Rp {{ number_format($item->active_wage_rate->rate_per_unit, 2, ',', '.') }}
                            @else
                    ...
                    @empty
                    <tr><td colspan="7" class="text-center py-4 text-body-secondary">Belum ada data kategori.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
