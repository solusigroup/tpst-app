    ...
    <div class="card-body">
        <form action="{{ route('admin.machines.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nomor_mesin') is-invalid @enderror" id="nomor_mesin" name="nomor_mesin" value="{{ old('nomor_mesin') }}" required>
                @error('nomor_mesin')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nama_mesin') is-invalid @enderror" id="nama_mesin" name="nama_mesin" value="{{ old('nama_mesin') }}" required>
                @error('nama_mesin')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
