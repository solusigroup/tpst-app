...
<div class="page-header d-print-none"><div><h1>Laporan Perubahan Ekuitas</h1></div><button class="btn btn-outline-secondary" onclick="window.print()"><i class="cil-print me-1"></i> Print</button></div>
