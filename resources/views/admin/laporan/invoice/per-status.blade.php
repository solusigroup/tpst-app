...
<div class="row">
    <div class="col-12">
        <div class="page-header d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="h4 mb-1">Rekap Invoice Per Status</h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="#">Laporan Operasional</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Invoice Per Status</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-header bg-white py-3">
                <form method="GET" action="{{ route('admin.laporan-operasional.invoice.per-status') }}" class="row g-3 align-items-end">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <a href="{{ route('admin.laporan-operasional.invoice.per-status') }}" class="btn btn-sm btn-outline-secondary">Reset</a>
                    </div>
                </form>
            </div>
