...
<div class="page-header d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        <?php if($invoice->klien && $invoice->klien->jenis === 'DLH'): ?>
            <form action="<?php echo e(route('admin.invoice.sync-dlh', $invoice)); ?>" method="POST" class="d-inline">
                <?php echo csrf_field(); ?>
    ...
    <div class="col-lg-8">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <h5 class="fw-bold mb-3 text-dark">
                            <?php echo e($invoice->klien->nama_klien ?? '-'); ?>
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header bg-white py-3 border-bottom d-flex justify-content-between align-items-center">
                ...
                <?php if($invoice->klien && ($invoice->klien->nama_klien === 'Dinas Lingkungan Hidup' || $invoice->klien->jenis === 'DLH')): ?>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="ps-4">
                                    <span class="d-block fw-bold">Ritase - <?php echo e($ritase->armada->plat_nomor ?? ($ritase->armada->nomor_polisi ?? '-')); ?></span>
                                    <small class="text-muted"><?php echo e(\Carbon\Carbon::parse($ritase->waktu_masuk)->format('d/m/Y H:i')); ?></small>
                                </td>
                                <td>
                                    <span class="badge bg-light text-dark border"><?php echo e($ritase->klien->nama_klien ?? '-'); ?> (<?php echo e($ritase->klien->jenis ?? '-'); ?>)</span>
                                </td>
                                <td>Tipping Fee</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-light text-dark border"><?php echo e($penjualan->klien->nama_klien ?? '-'); ?> (<?php echo e($penjualan->klien->jenis ?? '-'); ?>)</span>
                                </td>
