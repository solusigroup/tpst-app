    ...
    <div class="col-md-4">
        <div class="card mb-4">
            ...
            <div class="card-body border-top p-2">
                <div class="row g-2">
                    <div class="col-6">
                        <form action="<?php echo e(route('admin.hrd.wage-calculation.recalculate', $wageCalculation)); ?>" method="POST" onsubmit="return confirm('Peringatan: Upah akan dihitung ulang berdasarkan data kehadiran dan output terbaru. Lanjutkan?')">
                            <?php echo csrf_field(); ?>
