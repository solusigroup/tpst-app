...
<body>
    <div class="header">
        ...
        <?php if(request('search')): ?>
            <p>Pencarian: "<?php echo e(request('search')); ?>" (Berdasarkan: <?php echo e(ucfirst(str_replace('_', ' ', request('search_by', 'tiket')))); ?>)</p>
        <?php endif; ?>
    </div>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $ritase; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td class="text-center">
                        <span class="badge badge-<?php echo e(strtolower($item->status_invoice) == 'paid' ? 'selesai' : (strtolower($item->status_invoice) == 'sent' ? 'masuk' : (strtolower($item->status_invoice) == 'canceled' ? 'default' : 'timbang'))); ?>"><?php echo e($item->status_invoice ?? 'Unbilled'); ?></span>
                    </td>
    ...
    <div class="footer">
        <div class="signature-box">
            ...
            <p><strong><?php echo e(auth()->user()->name); ?></strong><br>Petugas</p>
        </div>
    </div>
</body>

</html><?php /**PATH D:\PROJECT_HERD\tpst-app\resources\views\admin\ritase\pdf-rekap.blade.php ENDPATH**/ ?>