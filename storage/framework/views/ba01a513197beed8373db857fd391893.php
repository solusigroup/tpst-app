            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e(number_format($item->total_output, 2, ',', '.')); ?> kg</td>
                        <td>
                        ...
                        <td class="text-end">
                            <a href="<?php echo e(route('admin.hrd.wage-calculation.show', $item)); ?>" class="btn btn-sm btn-outline-info"><i class="cil-search"></i> Detail</a>
                        </td>
                    </tr>
