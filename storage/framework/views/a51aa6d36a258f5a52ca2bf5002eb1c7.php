...
<table class="info-table">
    ...
    <tr>
        ...
        <td>: 
            ...
            <?php else: ?>
                <?php echo e(\Carbon\Carbon::parse($wageCalculation->week_start)->format('d/m/Y')); ?> s/d <?php echo e(\Carbon\Carbon::parse($wageCalculation->week_end)->format('d/m/Y')); ?>
...
<div class="total-box">
    <?php if($wageCalculation->user->salary_type === 'borongan' || $wageCalculation->total_quantity > 0): ?>
    Total Keseluruhan Output: <?php echo e(number_format($wageCalculation->total_quantity, 2, ',', '.')); ?> kg<br><br>
    <?php endif; ?>
    <?php if($wageCalculation->user->salary_type === 'bulanan'): ?>
    GAJI POKOK BULANAN: Rp <?php echo e(number_format($wageCalculation->user->monthly_salary ?? 0, 0, ',', '.')); ?><br>
    <?php else: ?>
    UPAH DASAR: Rp <?php echo e(number_format($wageCalculation->total_wage, 0, ',', '.')); ?><br>
    <?php endif; ?>
    
    <?php if($wageCalculation->overtime_pay > 0): ?>
    UPAH LEMBUR: Rp <?php echo e(number_format($wageCalculation->overtime_pay, 0, ',', '.')); ?><br>
    <?php endif; ?>
    
    <br>
    <strong>TOTAL UPAH DITERIMA: Rp <?php echo e(number_format($wageCalculation->total_wage + $wageCalculation->overtime_pay, 0, ',', '.')); ?></strong>
</div>
