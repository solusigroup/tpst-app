...
<div class="card">
    ...
    <div class="card-body border-bottom bg-danger bg-opacity-10 py-3">
        <div class="d-flex justify-content-between align-items-center">
            <div class="fw-semibold text-danger">
                <i class="cil-money me-2"></i> TOTAL UTANG 
                <?php if(request('search')): ?>
                    (Vendor: "<?php echo e(request('search')); ?>")
                <?php endif; ?>
            ...
            <div class="fs-4 fw-bold text-danger">Rp <?php echo e(number_format($totalJumlah ?? 0, 0, ',', '.')); ?></div>
        </div>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="8" class="text-center py-4 text-body-secondary">Belum ada data utang lancar.</td>
                    </tr>
                    <?php endif; ?>
                </tbody>
            </table>
