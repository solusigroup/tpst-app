...
<head>
    ...
    <title>Laporan Arus Kas - <?php echo e($tenant->name ?? 'TPST'); ?></title>
...
<?php endif; ?>
        <div class="text-center mb-10">
            ...
            <p class="text-sm text-zinc-500 font-medium mt-1 uppercase tracking-widest"><?php echo e($periodLabel); ?></p>
        </div>
        ...
        <div class="space-y-10">
            ...
            <section>
                ...
                <table class="w-full account-table text-sm">
                    <tbody>
                        <?php $__currentLoopData = $operasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="text-zinc-400 w-24 tabular-nums"><?php echo e($item->kode_akun); ?></td>
                            <td class="text-zinc-800"><?php echo e($item->nama_akun); ?></td>
                            <td class="text-right font-semibold tabular-nums">
                                <?php if($item->kas_bersih > 0): ?>
                                    Rp <?php echo e(number_format($item->kas_bersih, 0, ',', '.')); ?>

                                <?php else: ?>
                                    (Rp <?php echo e(number_format(abs($item->kas_bersih), 0, ',', '.')); ?>)
                                <?php endif; ?>
                            </td>
                        </tr>
                    ...
                    <tfoot>
                        <tr class="border-t-2 border-zinc-900">
                            ...
                            <td class="text-right py-4 font-black text-zinc-900">Rp <?php echo e(number_format($totalKasBersih, 0, ',', '.')); ?></td>
                        </tr>
                    </tfoot>
                </table>
            </section>
            ...
            <section class="bg-zinc-50 p-6 rounded-sm border border-zinc-100">
                <table class="w-full text-sm">
                    <tr class="h-10">
                        ...
                        <td class="text-right font-black text-zinc-900">Rp <?php echo e(number_format($totalKasBersih, 0, ',', '.')); ?></td>
                    </tr>
                    <tr class="h-10">
                        <td class="text-zinc-600 uppercase text-xs tracking-wider font-bold">Saldo Kas & Bank Awal Periode</td>
                        <td class="text-right font-black text-zinc-900">Rp <?php echo e(number_format($saldoAwal, 0, ',', '.')); ?></td>
                    </tr>
                    <tr class="h-12 border-t border-zinc-300">
                        ...
                        <td class="text-right font-black text-xl text-emerald-700">Rp <?php echo e(number_format($saldoAkhir, 0, ',', '.')); ?></td>
                    </tr>
                </table>
            </section>
        </div>
...
<?php /**PATH D:\PROJECT_HERD\tpst-app\resources\views\reports\arus-kas.blade.php ENDPATH**/ ?>