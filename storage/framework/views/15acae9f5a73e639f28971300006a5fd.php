        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr onclick="window.location='<?php echo e(route('admin.invoice.show', $item)); ?>'" style="cursor: pointer;">
                        <td><strong><?php echo e($item->nomor_invoice ?? '-'); ?></strong></td>
                        <td><?php echo e($item->klien->nama_klien ?? '-'); ?></td>
                        <td><span class="badge bg-light text-dark border"><?php echo e($item->klien->jenis ?? '-'); ?></span></td>
                        <td><?php echo e($item->periode_bulan); ?>/<?php echo e($item->periode_tahun); ?></td>
                        <td>Rp <?php echo e(number_format($item->total_tagihan, 0, ',', '.')); ?></td>
                        <td class="text-danger">Rp <?php echo e(number_format($item->uang_muka, 0, ',', '.')); ?></td>
                        <td class="fw-bold">Rp <?php echo e(number_format($item->total_tagihan - $item->uang_muka, 0, ',', '.')); ?></td>
                        <td>
