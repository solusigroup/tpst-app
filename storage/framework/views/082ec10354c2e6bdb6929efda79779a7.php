...
<div class="card">
    <div class="card-header bg-white py-3">
        <form method="GET" class="row g-2 align-items-end">
            <div class="col-auto"><input type="text" name="search" class="form-control" placeholder="Cari no. invoice..." value="<?php echo e(request('search')); ?>"></div>
            <div class="col-auto">
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead class="bg-light"><tr><th>No. Invoice</th><th>Klien</th><th>Periode</th><th>Total</th><th>Status</th><th>Tgl Invoice</th><th class="text-end">Aksi</th></tr></thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <div class="btn-group btn-group-sm">
                                ...
                                <form method="POST" action="<?php echo e(route('admin.invoice.destroy', $item)); ?>" class="d-inline" onsubmit="return confirm('Yakin hapus?')"><?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?><button class="btn btn-outline-danger"><i class="cil-trash"></i></button></form>
                            </div>
                        </td>
                    </tr>
