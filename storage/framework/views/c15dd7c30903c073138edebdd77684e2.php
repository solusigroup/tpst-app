...
<div class="card">
    <div class="card-header bg-white py-3">
        <form method="GET" class="row g-2 align-items-end">
            ...
            <?php if(request()->hasAny(['search','kategori','dari','sampai'])): ?><div class="col-auto"><a href="<?php echo e(route('admin.hasil-pilahan.index')); ?>" class="btn btn-outline-secondary">Reset</a></div><?php endif; ?>
        </form>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <div class="btn-group btn-group-sm">
                                ...
                                <form method="POST" action="<?php echo e(route('admin.hasil-pilahan.destroy', $item)); ?>" class="d-inline"><?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?><button type="submit" onclick="return confirm('Yakin ingin menghapus data ini?')" class="btn btn-outline-danger"><i class="cil-trash"></i></button></form>
                            </div>
                        </td>
                    </tr>
