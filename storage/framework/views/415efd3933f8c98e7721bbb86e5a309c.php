    ...
    <div class="max-w-4xl mx-auto bg-white p-12 shadow-xl print-container">
        ...
        <div class="flex justify-between items-start border-b-2 border-slate-900 pb-8 mb-10">
            ...
            <div class="text-right">
                ...
                <div class="space-y-1 text-sm font-sans uppercase tracking-wider font-bold">
                    ...
                    <p><span class="text-slate-400">Jatuh Tempo:</span> <?php echo e($invoice->tanggal_jatuh_tempo->format('d/m/Y')); ?></p>
                </div>
            </div>
        </div>
        ...
        <table class="w-full mb-12">
            ...
            <tbody class="text-sm divide-y divide-slate-100">
                <?php if($invoice->deskripsi_layanan): ?>
                    <tr>
                        <td class="px-4 py-6">
                            <p class="font-bold text-base"><?php echo nl2br(e($invoice->deskripsi_layanan)); ?></p>
                            <p class="text-slate-500 mt-1">Periode Layanan: <?php echo e($periodeLabel); ?></p>
                        </td>
                ...
                <?php else: ?>
                    ...
                    <tr>
                        <td class="px-4 py-6">
                            ...
                            <p class="text-slate-500 mt-1">Periode Layanan: <?php echo e($periodeLabel); ?> (<?php echo e($invoice->ritase->count()); ?> Ritase)</p>
                        </td>
                        <td class="px-4 py-6 text-center font-sans">
                        ...
                        <td class="px-4 py-6 text-right font-sans">
                            Rp <?php echo e(number_format($invoice->ritase->sum('biaya_tipping') / max(1, $totalTonnageRitase / 1000), 0, ',', '.')); ?>
                    ...
                    <tr>
                        <td class="px-4 py-6">
                            ...
                            <p class="text-slate-500 mt-1">
                                <?php $__currentLoopData = $invoice->penjualan->groupBy('jenis_produk'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php echo e($jenis); ?> (<?php echo e($items->count()); ?> Trans.), 
                        ...
                        <td class="px-4 py-6 text-right font-sans">
                            Rp <?php echo e(number_format($invoice->penjualan->sum('total_harga') / max(1, $totalTonnagePenjualan / 1000), 0, ',', '.')); ?>
            ...
            <tfoot>
                <tr>
                    <td colspan="2" rowspan="3" class="px-4 py-8 align-top italic text-slate-400 text-xs">
                        * Pembayaran dapat dilakukan via transfer ke Rekening <?php echo e($invoice->tenant->bank_name ?: 'Bank Mandiri'); ?> <br>
                        a/n <?php echo e($invoice->tenant->bank_account_name ?: $invoice->tenant->name); ?> No. Rek: <?php echo e($invoice->tenant->bank_account_number ?: '123-456-7890'); ?>

                    </td>
                    <td class="px-4 py-4 text-right font-bold uppercase text-xs tracking-wider text-slate-400">Subtotal</td>
                    <td class="px-4 py-4 text-right font-sans">Rp <?php echo e(number_format($invoice->total_tagihan, 0, ',', '.')); ?></td>
                </tr>
                <tr>
                ...
                <tr class="bg-slate-900 text-white">
                    ...
                    <td class="px-4 py-4 text-right font-black text-xl font-sans tracking-tight">Rp <?php echo e(number_format($invoice->total_tagihan, 0, ',', '.')); ?></td>
                </tr>
                <tr>
                    <td colspan="4" class="px-4 py-3 bg-slate-50 border-t border-slate-200">
                        ...
                        <p class="text-sm font-bold italic text-slate-700 uppercase">
                            # <?php echo e(\App\Helpers\Terbilang::make($invoice->total_tagihan)); ?> RUPIAH #
                        </p>
                    </td>
                </tr>
            </tfoot>
        ...
        <div class="grid grid-cols-3 gap-8 mt-24 text-center text-sm font-sans uppercase tracking-widest">
            ...
            <div>
                ...
                <div class="border-b border-slate-900 w-3/4 mx-auto pb-1 font-bold"><?php echo e($invoice->tenant->finance_name ?: 'Bagian Keuangan'); ?></div>
            </div>
            <div>
                <p class="mb-20">Hormat Kami,</p>
                <div class="border-b border-slate-900 w-3/4 mx-auto pb-1 font-bold"><?php echo e($invoice->tenant->director_name ?: 'Direktur'); ?></div>
...
<?php /**PATH D:\PROJECT_HERD\tpst-app\resources\views/invoices/print.blade.php ENDPATH**/ ?>