...
<head>
    ...
    <title>Laporan Laba Rugi - <?php echo e($period); ?></title>
...
<body class="bg-gray-100">
    <div class="fixed top-0 left-0 right-0 p-4 bg-white/80 backdrop-blur-md shadow-sm no-print z-50 flex justify-between items-center px-10">
        <div>
            ...
            <p class="text-sm text-gray-600 font-medium">Periode: <span class="text-indigo-600"><?php echo e($period); ?></span></p>
        </div>
...
<?php endif; ?>
        <div class="text-center mb-10">
            ...
            <p class="text-gray-500 font-medium uppercase tracking-widest mt-1">UNTUK PERIODE YANG BERAKHIR PADA <?php echo e($period); ?></p>
        </div>
            ...
            <section>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr>
                            <td class="py-3 w-2/3 text-gray-800 font-medium"><?php echo e($item->kode_akun); ?> - <?php echo e($item->nama_akun); ?></td>
                            <td class="py-3 text-right text-gray-600">Rp</td>
                            <td class="py-3 text-right text-gray-900 font-bold w-32"><?php echo e(number_format($item->total, 2, ',', '.')); ?></td>
                        </tr>
                    ...
                    <tfoot>
                        <tr class="font-extrabold text-gray-900 bg-gray-50">
                            ...
                            <td class="py-4 text-right border-t-2 border-gray-900"><?php echo e(number_format($totalRevenue, 2, ',', '.')); ?></td>
                        </tr>
                    </tfoot>
                </table>
            </section>
                ...
                <table class="w-full text-sm">
                    ...
                    <tfoot>
                        <tr class="font-extrabold text-gray-900 bg-gray-50">
                            ...
                            <td class="py-4 text-right">Rp</td>
                            <td class="py-4 text-right border-t-2 border-gray-900">(<?php echo e(number_format($totalExpenses, 2, ',', '.')); ?>)</td>
                        </tr>
                    </tfoot>
                </table>
            </section>
            ...
            <section class="border-t-4 border-double border-gray-900 pt-6">
                <div class="bg-gray-900 text-white p-6 rounded-lg flex justify-between items-center">
                    ...
                    <div class="text-right">
                        ...
                        <span class="text-3xl font-black <?php echo e($netProfit >= 0 ? 'text-green-400' : 'text-red-400'); ?>">
...
<?php endif; ?>
        ...
        <div class="mt-16 text-[10px] text-gray-400 border-t border-gray-100 pt-4 flex justify-between italic">
            ...
            <span>Waktu Cetak: <?php echo e(now()->format('d/m/Y H:i:s')); ?></span>
        </div>
    </div>
</body>
</html>
<?php /**PATH D:\PROJECT_HERD\tpst-app\resources\views\reports\laba-rugi.blade.php ENDPATH**/ ?>