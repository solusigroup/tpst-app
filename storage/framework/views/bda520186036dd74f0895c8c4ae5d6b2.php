...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
    <tbody>
        ...
        <tr>
            <td style="border: 1px solid #ddd; padding: 5px;"><?php echo e($item->kode_akun); ?> - <?php echo e($item->nama_akun); ?></td>
            <td style="border: 1px solid #ddd; padding: 5px; text-align: right;">Rp <?php echo e(number_format($item->saldo, 0, ',', '.')); ?></td>
        </tr>
    ...
    <tfoot>
        <tr>
            ...
            <td style="border: 1px solid #ddd; padding: 5px; text-align: right; color: #198754; font-weight: bold;">Rp <?php echo e(number_format($totalPendapatan, 0, ',', '.')); ?></td>
        </tr>
    </tfoot>
</table>
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
    ...
    <tfoot>
        <tr>
            ...
            <td style="border: 1px solid #ddd; padding: 5px; text-align: right; color: #dc3545; font-weight: bold;">Rp <?php echo e(number_format($totalBeban, 0, ',', '.')); ?></td>
        </tr>
    </tfoot>
</table>
...
<table style="width: 100%; border-collapse: collapse; border-top: 2px solid #333; margin-top: 20px;">
    <tr>
        ...
        <td style="border: 1px solid #ddd; padding: 10px; text-align: right; font-weight: bold; font-size: 14px; <?php echo e($labaRugiBersih >= 0 ? 'color: #198754;' : 'color: #dc3545;'); ?>">
            Rp <?php echo e(number_format($labaRugiBersih, 0, ',', '.')); ?>
...
<?php echo $__env->make('admin.laporan.exports.layout', ['title' => 'Laporan Laba Rugi'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT_HERD\tpst-app\resources\views\admin\laporan\exports\laba-rugi-export.blade.php ENDPATH**/ ?>