        ...
        <form method="GET" class="row g-2 align-items-end">
            ...
            <div class="col-auto">
                <select name="jenis" class="form-select">
                    ...
                    <?php $__currentLoopData = ['DLH','Swasta','Offtaker']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><strong><?php echo e($item->nama_klien); ?></strong></td>
                        <td><span class="badge bg-primary"><?php echo e($item->jenis); ?></span></td>
                        ...
                        <td class="text-end">
                            <div class="btn-group btn-group-sm">
                                ...
                                <form method="POST" action="<?php echo e(route('admin.klien.destroy', $item)); ?>" class="d-inline" onsubmit="return confirm('Yakin hapus?')"><?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?><button class="btn btn-outline-danger"><i class="cil-trash"></i></button></form>
                            </div>
                        </td>
                    </tr>
