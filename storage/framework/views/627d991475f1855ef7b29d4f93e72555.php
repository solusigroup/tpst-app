        ...
        <div class="hero-side">
            <div class="hero-content">
                <div class="hero-main-logo">
                    ...
                    <img src="<?php echo e(asset('logo-lamongan.png')); ?>" alt="Logo Kabupaten Lamongan"
                        onerror="this.src='<?php echo e(asset('favicon.png')); ?>'">
                </div>
        ...
        <div class="login-side">
            <div class="login-card">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" id="login" name="login" class="form-input"
                                placeholder="Masukkan email atau username" value="<?php echo e(old('login')); ?>" required
                                autofocus>
                ...
                <div class="login-footer">
                    &copy; <?php echo e(date('Y')); ?> <a href="https://simpleakunting.biz.id/SolusiConsult.html">SimpleAkunting by
...
</html><?php /**PATH D:\PROJECT_HERD\tpst-app\resources\views/welcome.blade.php ENDPATH**/ ?>