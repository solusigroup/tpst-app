...
<body class="bg-gray-50 flex items-center justify-center min-h-screen relative p-4" style="background-image: url('<?php echo e(asset('images/bg-login.jpg')); ?>'); background-size: cover; background-position: center;">
        ...
        <form method="POST" action="<?php echo e(route('password.update')); ?>" class="space-y-4">
            ...
            <div class="space-y-2">
                ...
                <input id="email" type="email" name="email" value="<?php echo e(old('email', $request->email)); ?>" required autofocus
                    class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-amber-500 focus:border-amber-500 <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-2">
                ...
                <input id="password" type="password" name="password" required
                    class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-amber-500 focus:border-amber-500 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
<?php /**PATH D:\PROJECT_HERD\tpst-app\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>