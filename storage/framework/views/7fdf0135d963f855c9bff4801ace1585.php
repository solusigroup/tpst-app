...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-end">Rp <?php echo e(number_format($item->total_wage, 0, ',', '.')); ?></td>
            <td class="text-end">Rp <?php echo e(number_format($item->overtime_pay, 0, ',', '.')); ?></td>
            <td class="text-end"><strong>Rp <?php echo e(number_format($item->total_wage + $item->overtime_pay, 0, ',', '.')); ?></strong></td>
            <td>
