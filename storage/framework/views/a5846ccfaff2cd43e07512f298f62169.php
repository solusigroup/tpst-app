...
<div class="row">
    <div class="col-md-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.hrd.employee.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('ktp_number')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('joined_at')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('ended_at')); ?>">
...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="Tidak Aktif" <?php echo e(old('bpjs_status') == 'Tidak Aktif' ? 'selected' : ''); ?>>Tidak Aktif</option>
                                <option value="Aktif" <?php echo e(old('bpjs_status') == 'Aktif' ? 'selected' : ''); ?>>Aktif</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('bpjs_number')); ?>">
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <option value="bulanan" <?php echo e(old('salary_type') == 'bulanan' ? 'selected' : ''); ?>>Bulanan</option>
                                <option value="borongan" <?php echo e(old('salary_type') == 'borongan' ? 'selected' : ''); ?>>Borongan</option>
                                <option value="harian" <?php echo e(old('salary_type') == 'harian' ? 'selected' : ''); ?>>Harian</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6" id="payment_frequency_container" style="display: <?php echo e(old('salary_type') == 'bulanan' ? 'none' : 'block'); ?>;">
...
unset($__errorArgs, $__bag); ?>">
                                <option value="Mingguan" <?php echo e(old('payment_frequency') == 'Mingguan' ? 'selected' : ''); ?>>Mingguan (Tiap Sabtu)</option>
                                <option value="Dua Mingguan" <?php echo e(old('payment_frequency') == 'Dua Mingguan' ? 'selected' : ''); ?>>Dua Mingguan</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row mb-3" id="monthly_salary_container" style="display: <?php echo e(old('salary_type') == 'bulanan' ? 'flex' : 'none'); ?>;">
                        <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('monthly_salary')); ?>" min="0" step="1">
                            </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row mb-3" id="daily_wage_container" style="display: <?php echo e(old('salary_type') == 'harian' ? 'flex' : 'none'); ?>;">
                        <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('daily_wage')); ?>" min="0" step="1">
                            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateDefaultWage() {
            ...
            if (salaryTypeSelect.value === 'harian' && (!currentWage || currentWage == '70000' || currentWage == '65000')) {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT_HERD\tpst-app\resources\views\admin\hrd\employee\create.blade.php ENDPATH**/ ?>