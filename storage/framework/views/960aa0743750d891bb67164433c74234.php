<?php $__env->startSection('title', 'Isi Logbook Mesin'); ?>
...
<div class="card col-md-8">
    <div class="card-body">
        <form action="<?php echo e(route('admin.machine-logs.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="machine_id" name="machine_id" required>
                        ...
                        <?php $__currentLoopData = $machines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $machine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($machine->id); ?>" <?php echo e(old('machine_id') == $machine->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="waktu_cek" name="waktu_cek" required>
                        ...
                        <option value="Engine On" <?php echo e(old('waktu_cek') == 'Engine On' ? 'selected' : ''); ?>>Engine On (Pagi / Mulai Operasi)</option>
                        <option value="Engine Off" <?php echo e(old('waktu_cek') == 'Engine Off' ? 'selected' : ''); ?>>Engine Off (Sore / Selesai Operasi)</option>
                    </select>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="form-check p-3 border rounded h-100 shadow-sm" style="background-color: rgba(16, 185, 129, 0.05); border-left: 4px solid #10b981 !important;">
                            <input class="form-check-input ms-1" type="radio" name="status_lampu" id="statusHijau" value="Hijau" <?php echo e(old('status_lampu') == 'Hijau' ? 'checked' : ''); ?> required>
                    ...
                    <div class="col-md-6">
                        <div class="form-check p-3 border rounded h-100 shadow-sm" style="background-color: rgba(245, 158, 11, 0.05); border-left: 4px solid #f59e0b !important;">
                            <input class="form-check-input ms-1" type="radio" name="status_lampu" id="statusKuning" value="Kuning" <?php echo e(old('status_lampu') == 'Kuning' ? 'checked' : ''); ?>>
                    ...
                    <div class="col-md-6">
                        <div class="form-check p-3 border rounded h-100 shadow-sm" style="background-color: rgba(6, 182, 212, 0.05); border-left: 4px solid #06b6d4 !important;">
                            <input class="form-check-input ms-1" type="radio" name="status_lampu" id="statusBiru" value="Biru" <?php echo e(old('status_lampu') == 'Biru' ? 'checked' : ''); ?>>
                    ...
                    <div class="col-md-6">
                        <div class="form-check p-3 border rounded h-100 shadow-sm" style="background-color: rgba(239, 68, 68, 0.05); border-left: 4px solid #ef4444 !important;">
                            <input class="form-check-input ms-1" type="radio" name="status_lampu" id="statusMerah" value="Merah" <?php echo e(old('status_lampu') == 'Merah' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="keterangan" name="keterangan" rows="3" placeholder="Isi catatan khusus jika status Kuning, Biru, atau Merah"><?php echo e(old('keterangan')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT_HERD\tpst-app\resources\views\admin\machine_logs\create.blade.php ENDPATH**/ ?>