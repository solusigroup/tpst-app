...
<div class="page-header">
    ...
    <div class="d-flex gap-2">
        <a href="<?php echo e(route('admin.klien.print', request()->all())); ?>" class="btn btn-danger" target="_blank"><i class="cil-print me-1"></i> Cetak (PDF)</a>
        <a href="<?php echo e(route('admin.klien.export-excel', request()->all())); ?>" class="btn btn-success"><i class="cil-file me-1"></i> Export Excel</a>
