...
<head>
    ...
    <title><?php echo e(config('app.name', 'TPST App')); ?> — Registrasi</title>
...
<body>
    ...
    <div class="register-card">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input
                        ...
                        id="name"
                        name="name"
                        class="form-input <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>"
        ...
        <div class="login-footer">
            &copy; <?php echo e(date('Y')); ?> <a href="https://simpleakunting.id">SimpleAkunting</a>. All rights reserved.
        </div>
    </div>
...
<?php /**PATH D:\PROJECT_HERD\tpst-app\resources\views\auth\register.blade.php ENDPATH**/ ?>