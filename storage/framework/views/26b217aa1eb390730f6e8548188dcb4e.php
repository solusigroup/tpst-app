...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="datetime-local" id="waktu_masuk" name="waktu_masuk" class="form-control <?php $__errorArgs = ['waktu_masuk'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('waktu_masuk', isset($ritase) ? \Carbon\Carbon::parse($ritase->waktu_masuk)->format('Y-m-d\TH:i') : '')); ?>" required onchange="updateWaktuKeluar()">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="datetime-local" id="waktu_keluar" name="waktu_keluar" class="form-control <?php $__errorArgs = ['waktu_keluar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status" class="form-select" required>
                            <?php $__currentLoopData = ['masuk'=>'Masuk','timbang'=>'Timbang','keluar'=>'Keluar','selesai'=>'Selesai']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val); ?>" <?php echo e(old('status', $ritase->status ?? 'selesai') == $val ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="foto_tiket_bruto" id="foto_tiket_bruto" class="form-control d-none <?php $__errorArgs = ['foto_tiket_bruto'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" accept="image/*" capture="environment" onchange="previewImageBruto(this)">
                        <div id="file-name-display-bruto" class="small text-muted mb-2"></div>
                        <?php $__errorArgs = ['foto_tiket_bruto'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div id="image-preview-bruto" class="mt-2 text-center border p-2 rounded <?php echo e((isset($ritase) && $ritase->foto_tiket_bruto) ? '' : 'd-none'); ?>">
                            <?php if(isset($ritase) && $ritase->foto_tiket_bruto): ?>
                                <a href="<?php echo e(asset('storage/' . $ritase->foto_tiket_bruto)); ?>" target="_blank" id="preview-link-bruto">
                                    <img src="<?php echo e(asset('storage/' . $ritase->foto_tiket_bruto)); ?>" id="preview-img-bruto" class="img-fluid rounded" style="max-height: 200px;">
                                </a>
                            <?php else: ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="foto_tiket_tarra" id="foto_tiket_tarra" class="form-control d-none <?php $__errorArgs = ['foto_tiket_tarra'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" accept="image/*" capture="environment" onchange="previewImageTarra(this)">
                        <div id="file-name-display-tarra" class="small text-muted mb-2"></div>
                        <?php $__errorArgs = ['foto_tiket_tarra'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback d-block"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div id="image-preview-tarra" class="mt-2 text-center border p-2 rounded <?php echo e((isset($ritase) && $ritase->foto_tiket_tarra) ? '' : 'd-none'); ?>">
                            <?php if(isset($ritase) && $ritase->foto_tiket_tarra): ?>
                                <a href="<?php echo e(asset('storage/' . $ritase->foto_tiket_tarra)); ?>" target="_blank" id="preview-link-tarra">
                                    <img src="<?php echo e(asset('storage/' . $ritase->foto_tiket_tarra)); ?>" id="preview-img-tarra" class="img-fluid rounded" style="max-height: 200px;">
                                </a>
                            <?php else: ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(function() {
        ...
        function loadAsalSampah(klienId) {
            ...
            fetch('<?php echo e(route("admin.ritase.asal-sampah")); ?>?klien_id=' + klienId, {
